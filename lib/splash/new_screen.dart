...
class _JobizoInfoSectionState extends State<JobizoInfoSection> {
  ...
  Widget build(BuildContext context) {
    ...
    final double rating = (data['rating_out_of_5'] is num)
        ? (data['rating_out_of_5'] as num).toDouble()
        : 0.0;
    final int satisfaction = (data['satisfaction_percentage'] ?? 0) as int;
    final int totalFeedbacks = (data['total_feedbacks'] ?? 0) as int;
    final String feedbackSummary = (data['feedback_summary'] ??
            'Excellent service and professional workers')
        .toString();

    final List services =
        (data['services'] is List) ? (data['services'] as List) : const [];
    final List locations =
        (data['locations'] is List) ? (data['locations'] as List) : const [];
    final String locationsLine = locations
        .map((e) => (e is Map && e['work_address'] != null)
            ? e['work_address'].toString()
            : '')
    ...
    return Scaffold(
      ...
      decoration: BoxDecoration(
        gradient: AppGradients.yellowOrangeVertical, // or AppGradients.Green
      ),
      child: _loading
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Image.asset('Assets/jobizo/onboard3.png',
                                  height: 120),
                              const SizedBox(height: 12),
                              Row(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 12),
                              Image.asset('Assets/Labour_image/map.png',
                                ...
                                children: services.isEmpty
                                    ...
                                    : services.map<Widget>((s) {
                                        ...
                                        return _buildServiceTile(
                                            _iconFor(name), _capitalize(name));
                                      }).toList(),
                              ),
                            ],
                          ),
