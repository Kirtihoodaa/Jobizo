...
class CDeleteaccount extends StatefulWidget {
  const CDeleteaccount({super.key});

  @override
  State<CDeleteaccount> createState() => _CDeleteaccountState();
}

class _CDeleteaccountState extends State<CDeleteaccount> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Commonappbar(title: "Delete Account"),
      body: Padding(
