...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> fetchDashboardData() async {
    ...
    try {
      final response = await dio.get("https://backend.jobizoindia.com/api/labour-dashboard");
        ...
        child: Padding(
          ...
          child: Column(
            ...
            backgroundImage: imageUrl != null
                ...
                : AssetImage("Assets/Labour_image/user profile.png") as ImageProvider,
          ),
              const SizedBox(height: 10),

                  const SizedBox(height: 10),
                  Text(profile?['name'] ?? 'N/A',
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: primary())),
                  SizedBox(height: 5),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Text(
          ...
          style: TextStyle(
              color: Colors.green, fontWeight: FontWeight.bold, fontSize: tertiary()),
        ),
      ),
    );
  }
